...
<body>
    ...
    <button id="drawPentagonBtn">Marcus Rashford - FW</button>
    ...
    $('#drawPentagonBtn').on('click', function(){
        var buttonText = $(this).text(); // Get the text content of the button
        var playerInfo = buttonText.split(' - '); // Split the text by ' - ' to get name and position
        var playerName = playerInfo[0]; // Get player name
        var playerPosition = positionMap[playerInfo[1]]; // Get player position
        ...
        if(playerPosition) {
            ...
            $.ajax({
                ...
                function drawPentagon(canvasId, playerStats) {
                    ...
                    player.life = player.life || 61;
                    player.defense = player.defense || 45;
                    player.agility = player.agility || 33;
                    player.intellect = player.intellect || 69;
                    player.power = player.power || 42;
                ...
                // Call the main function with the player's name
